...
document.addEventListener("DOMContentLoaded", function() {
    ...
    alert("You Have Five Minutes to Hand In Your Sprint 3 Project!");
  
    // The rest of your code here...
    // (Your existing code for custom alerts, buttons, etc.)
  });
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function AboutToRun() {
      ...
      customAlert.style.display = "block";
      text.textContent = "OMG it's running away!!";
      ...
      function Running() {
          ...
          const wrapperRect = wrapper.getBoundingClientRect();
          const buttondanceRect = yesBtn.getBoundingClientRect(); 
